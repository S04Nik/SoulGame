...
namespace DarkSoul
{
    public class UIManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            ///
            equipmentWindowUI.handEquipmentSlotUI = GetComponentsInChildren<HandEquipmentSlotUI>(true);
            equipmentWindowUI.LoadWeaponOnEquipmentScreen(inventory);
        }
        ...
        {          
            ...
            {
                if(i < inventory.weaponsInventory.Count)
                {
                    if(weaponInventorySlots.Length < inventory.weaponsInventory.Count)
                    {
                        Instantiate(weaponInventorySlotPrefab, weaponInventorySlotsParent);
                        weaponInventorySlots = weaponInventorySlotsParent.GetComponentsInChildren<WeaponInventorySlot>(true);
                    }
                    weaponInventorySlots[i].AddItem(inventory.weaponsInventory[i]);
                }
                else
                {
